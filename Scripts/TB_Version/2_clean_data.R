...
clean_upload_tbl %>%
  ...
  compute(name = "DQ_STATE", temporary = TRUE, overwrite = TRUE) # (temporary = TRUE) This table will disappear once the connection has been ended (can easily be re-made)
...
clean_upload_tbl %>%
  ...
  compute(
    name = "DQ_CONGRESSIONAL_DISTRICT",
    temporary = TRUE,
    overwrite = TRUE
  )
...
clean_upload_tbl %>%
  ...
  compute(name = "DQ_COUNTY", temporary = TRUE, overwrite = TRUE) # (temporary = TRUE) This table will disappear once the connection has been ended (can easily be re-made)
...
clean_upload_tbl %>%
  ...
  compute(name = "DQ_SCHOOL_DISTRICT", temporary = TRUE, overwrite = TRUE)
...
clean_upload_tbl %>%
  ...
  compute(name = "DQ_CENSUS_TRACT", temporary = TRUE, overwrite = TRUE) # (temporary = TRUE) This table will disappear once the connection has been ended (can easily be re-made)
...
clean_upload_tbl %>%
  ...
  compute(name = "DQ_CENSUS_BLOCK_GROUP", temporary = TRUE, overwrite = TRUE) # (temporary = TRUE) This table will disappear once the connection has been ended (can easily be re-made)
...
clean_upload_tbl %>%
  ...
  compute(name = "DQ_CENSUS_BLOCK", temporary = TRUE, overwrite = TRUE) # (temporary = TRUE) This table will disappear once the connection has been ended (can easily be re-made)
...
clean_upload_tbl %>%
  ...
  compute(name = "DQ_ZCTA", temporary = TRUE, overwrite = TRUE) # (temporary = TRUE) This table will disappear once the connection has been ended (can easily be re-made)
