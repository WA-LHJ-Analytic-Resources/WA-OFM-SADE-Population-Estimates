...
5. Run `1_pull_data.R` to pull all of WA OFM's internal SADE population estimates and save it locally (to the `DUCKDB_FILEPATH` provided in `.Renviron`). **Note: This script takes approximately 80 minutes to complete the API pull (it's a lot of data)**
6. Open `2_use_data.R` to see an example of how pulled data can be used to prepare AOIC Race-Ethnicity population estimates. Adapt for your own population health analyses.
